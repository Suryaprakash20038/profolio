...
const Contact = () => {
    return (
        <section id="contact" className="py-24 bg-[#FAFAFA] text-evergreen relative">
                    ...
                    >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-3">
                                ...
                                <input type="text" className="w-full bg-white border border-mint rounded-2xl px-6 py-4 text-evergreen font-semibold focus:outline-none focus:border-emerald focus:ring-4 focus:ring-emerald/10 transition-all shadow-sm placeholder:text-royal/40" placeholder="John Doe" />
                            </div>
                            <div className="space-y-3">
                                <label className="text-[10px] font-black text-royal/60 uppercase tracking-[0.2em] ml-2">Subject</label>
                                <input type="text" className="w-full bg-white border border-mint rounded-2xl px-6 py-4 text-evergreen font-semibold focus:outline-none focus:border-emerald focus:ring-4 focus:ring-emerald/10 transition-all shadow-sm placeholder:text-royal/40" placeholder="Project Inquiry" />
                            </div>
                        </div>

                        <div className="space-y-3">
                            <label className="text-[10px] font-black text-royal/60 uppercase tracking-[0.2em] ml-2">Email Address</label>
                            <input type="email" className="w-full bg-white border border-mint rounded-2xl px-6 py-4 text-evergreen font-semibold focus:outline-none focus:border-emerald focus:ring-4 focus:ring-emerald/10 transition-all shadow-sm placeholder:text-royal/40" placeholder="john@example.com" />
                        </div>
                        ...
                        <motion.button
                            ...
                            whileTap={{ scale: 0.98 }}
                            className="w-full mt-6 bg-evergreen text-white font-black py-5 rounded-2xl shadow-button hover:shadow-premium hover:bg-emerald transition-all text-[15px] uppercase tracking-[0.2em]"
                        >
                            Send Message
                        </motion.button>
                    </motion.form>
